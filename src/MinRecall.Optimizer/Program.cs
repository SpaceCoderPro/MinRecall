...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            var serviceName = "MinRecall Optimizer Service";
        ...
        {
            LogFatalError("Fatal error in OptimizerService", ex);
    ...
    private static void WriteToLogFile(string message, bool isError = false)
    {
        try
        {
            ...
            var logFile = Path.Combine(logFolder, $"OptimizerService_{DateTime.Now:yyyyMMdd}.log");
